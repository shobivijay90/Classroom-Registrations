...
/* Template Name: Classroom Registration */ 
?>
...
.info input, textarea,
#specialtyname,
#audiencelevel, #asynchronous-education, #zoom-test {
  padding: 15px;
...
<body>
    ...
    <section id="classroompage">
        ...
        <section id="image">
            <img src="https://health4theworld.org/academy/wp-content/uploads/2019/12/Students-Image.png" class="docimage"
                alt="doctorsimage">
        </section>

        <section id="desc">
            <div class="clickregister">
                <a href="#classroomform" class="register">REGISTER TO ATTEND</a>
            </div>
            <h4>OUR MISSION</h4>
            ...
            <h4>WHAT WILL YO DO?</h4>
            <p style="text-align: justify;">You will attend a lecture in your selected specialty via a live web-conference, from top medical professionals in the United states and Europe. The recorded lecture will be cataloged for future student reference on our Academy website & mobile app. <a href="https://health4theworld.org/academy/course/acute-myocardial-infarction-vascular-biology-and-treatment-implications/"
        ...
        <section id="form">
            <a id="classroomform"></a>
            <div class="progressbar">
                <div id="personal" class="tab">Personal Details</div>
                <div id="lecture" class="tab">Session Details</div>
                <div id="availability" class="tab">Availability</div>
            </div>
            <form action="https://health4theworld.org/academy/wp-content/themes/wplms/classroom-insert.php" method="post" id="msform">
                <fieldset id="set1">
                    <h1>CLASSROOM REGISTRATION FORM</h1><br>
                    ...
                    <div class="info">
                        ...
                        <div class="errormsg">Please enter text</div>
                    </div>
                    ...
                    <div class="info">
                        <label>University/ Hospital*</label>
                    ...
                    <div class="info">
                        ...
                        <div class="errormsg">Please enter a valid email address</div>
                    </div>
                    ...
                    <div class="info">
                        ...
                        <div class="errormsg">Please enter valid cell phone number</div>
                    </div>
                    <button type="button" class="formbutton" id="nextset1">Next</button>
                </fieldset>
   
                <fieldset id="set2">
                    <h2 class="fs-title">SESSION DETAILS<span class="responserequired">(*Response Required)</span></h2>
                    <br>
                    <div class="info">
                        <label>Which specialty would you like education to be?*</label>
                        ...
                        <div class="errormsg">Please select specialty</div>
                        <p class="des">If your specialty is not present in this list, Please<a
                             href="https://docs.google.com/forms/d/e/1FAIpQLSfFlUoGvWGwfx8XgMmRSZe7LQts1L-OWFthsvpf0ZMpUPQH8g/viewform" target="_blank"> CLICK HERE</a> to fill the
                            form.
                        </p>
                    </div>

                    <div class="info">
                        <label>What topics would you like to learn? List 5 top topics of your choice.*</label>
                        <textarea rows="5" cols="70" placeholder="Enter topics.." name="topics_interested"></textarea>
                    ...
                    <div class="info">
                        <label style="line-height: 1.5;">who is the audience?*</label>
                    ...
                    <div class="info">
                        <label>Default language in sessions are english. If you need sessions in other language. Please specify.</label>
                        <textarea rows="1" cols="70" placeholder="Enter languages.." name="language_interested"></textarea>
                        <div class="errormsg">Please enter text</div>
                    </div>
                ...
                <fieldset id="set3">
                    ...
                    <div class="info">
                        <label style="text-align: justify;">Available live session(s) for selected specialty*(The online grandrounds are done at 7:00 AM PST on Mondays in Obstetrics & Pediatrics, Tuesdays in Internal Medicine, Wednesdays in Emergency
                            medicine, Thursdays in Surgery, Fridays in Radiology & Community health on any day.)</label>
                        ...
                        <input id="endtimepicker" name="end_time" placeholder="Select end time (PST)"
                            onfocus="this.value=''"
                            readonly/>
                        <div class="errormsg">Please enter valid date and time</div>
                    </div>

                    <div class="info">
                           <label>If 7:00 AM PST does not work, What are the other times would you prefer?</label>
                           <input id="preferred-times" name="preferred_times" placeholder="Select preferred times (PST)" onfocus="this.value=''"
                               readonly />
                               <div class="errormsg">Please enter a valid time!</div>
                              
                    </div>
                    <div class="info">
                           <label>Sessions are mostly conducted live. If live lecture not possible due to lack of speaker times, are you open to asynchronous education and the students looking at as a recorded lecture?</label>
                           <select id="asynchronous-education" name="asynchronous_education" data-default-value="" required>
               
                            <option value="Yes">Yes</option>
                            <option value="No">No</option>
       
                        </select>
                               <div class="errormsg">This field is required!</div>
                              
                    </div>
                    <div class="info">
                           <label>Sessions are conducted using zoom. Would you like to prefer a zoom test before grandrounds?</label>
                           <select id="zoom-test" name="zoom_test" data-default-value="" required>
