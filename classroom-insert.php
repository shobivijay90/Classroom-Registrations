...
$topics_interested = $_POST['topics_interested'];
$audience = $_POST['audience'];
$language_interested = $_POST['language_interested'];
$available_date = $_POST['available_date'];
$start_time = $_POST['start_time'];
$end_time = $_POST['end_time'];
$preferred_times = $_POST['preferred_times'];
$asynchronous_education = $_POST['asynchronous_education'];
$zoom_test = $_POST['zoom_test'];

//inserting data to php form
$sql="INSERT INTO classroom_registrations (firstname, lastname, title_department, institution, email, phonenumber, specialty, topics_interested, audience language_interested, available_date, start_time, end_time, preferred_times,asynchronous_education, zoom_test)
VALUES
('$firstname', '$lastname', '$title_department', '$institution', '$email', '$phonenumber', '$specialty', '$topics_interested','$audience', '$language_interested', '$available_date', '$start_time', '$end_time', '$preferred_times','$asynchronous_education', '$zoom_test')";
...
$message .= '<p>Please see your classroom details below:</p>'; 
...
$message .= '<p>Please reply to this email, If you want to cancel your classroom session.</p>';
$message .= "</body></html>";
...
$headers .= 'Cc: shobivijay90@gmail.com' . "\r\n"; 
//$headers .= 'Bcc: welcome2@example.com' . "\r\n"; 

mail($to, $subject, $message, $headers);

$link = "https://health4theworld.org/academy/wp-content/themes/wplms/classroom-thankyou.php";
